...
# Model, 임계값
model = 'D:\\frozen_east_text_detection.pb'
confThreshold = 0.6
nmsThreshold = 0.4

# Test Image
img_files = ['road_closed.jpg', 'patient.jpg', 'copy_center.jpg', 'text1.jpg', 'text2.jpg', 'text3.jpg', 'text4.jpg', 'text5.jpg']
...
for i in os.listdir("Input"):
    ...
    # feature_fusion/concat_3 → RBOX(Rotate) / geometry map
    ...
    for i in indices:
        ...
        for j in range(4):
            ...
            FontoutName = "Output//" + tempName
            cv2.imwrite(FontoutName, img)
